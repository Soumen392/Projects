  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className='min-w-60'>
        <p onClick={()=>setShowFilter(!showFilter)} className='my-2 select-none text-xl flex items-center cursor-pointer gap-2'>FILTERS
      ...
      <div className='flex-1 '>
        <div className='flex justify-between text-base sm:text-2xl mb-4'>
          ...
          {/* Product Sort */}
          <select onChange={(e)=>setSortType(e.target.value)} className='select-none border-2 border-gray-300 text-sm px-2'>
